package cn.cqs.adapter.recyclerview.wrapper;
...
import cn.cqs.adapter.recyclerview.utils.WrapperUtils;
...
public class AdapterWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private int mEmptyViewId;//= R.layout.layout_empty;
    private RecyclerView.Adapter mInnerAdapter;

    public AdapterWrapper(RecyclerView.Adapter adapter) {
        this.mInnerAdapter = adapter;
        this.mInnerAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
    ...
    private boolean isEmpty() {
        return mEmptyViewId != 0 && getRealItemCount() == 0;
    }
